...
type UpdateAppReq struct {
	...
	Name        string `json:"name,omitempty" validate:"required,gte=3,lte=128"`
	PackageName string `json:"package_name,omitempty" validate:"required,gte=3,lte=128,unique-package-name-rule"`
	Photo       string `json:"photo,omitempty" validate:"url"`
