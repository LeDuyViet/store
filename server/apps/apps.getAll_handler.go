/* !!
 * File: apps.getAll_handler.go
 * File Created: Wednesday, 26th July 2023 2:41:51 pm
 * Author: KimEricko™ (phamkim.pr@gmail.com)
 * -----
 * Last Modified: Wednesday, 26th July 2023 3:01:15 pm
...
/* !!
 * File: stores.getAll_handler.go
 * File Created: Wednesday, 26th July 2023 10:02:56 am
 * Author: KimEricko™ (phamkim.pr@gmail.com)
 * -----
 * Last Modified: Wednesday, 26th July 2023 2:33:12 pm
 * Modified By: KimEricko™ (phamkim.pr@gmail.com>)
 * -----
 * Copyright 2022 - 2023 Volio, Volio Vietnam
 * All rights reserved.
...
func (api *AppsAPI) GetAll(ctx *fiber.Ctx) error {
